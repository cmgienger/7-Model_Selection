...
Added variable plot provides information about the marginal (adjusted) importance of a predictor variable 𝑋
, given the other predictor variables already in the model. It shows the marginal importance of the variable in reducing the residual (unexplained) variability.
