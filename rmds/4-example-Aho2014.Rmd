...
anova (model_washburn1) #coefficients of the full model
```
\
...
```{r ols_plot_added_variable, message=FALSE, warning=FALSE, fig.width=6}
olsrr::ols_plot_added_variable(model_washburn1)
```
