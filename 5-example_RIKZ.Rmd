...
**Exposure** is an index that is composed of wave action, length of the surf zone, slope, grain size and the depth of the anaerobic layer.
...
```{r compare models}
model_comparison<-model.sel(mixed_model_IntOnly_Full, mixed_model_IntOnly_NoInter, mixed_model_IntOnly_NAP, mixed_model_IntOnly_Exp, mixed_model_IntOnly_NoFix)
